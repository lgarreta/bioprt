...
the tm-score value.
INPUT  : The name of the input dir with the protein structures
OUTPUT : A file named as the input dir plus the suffix ".dist" containing the 
         matrix of dissimilarites.
"""
USAGE="calculate-dist-matriz-tmscore.py <input dir>"
